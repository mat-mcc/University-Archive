...
# Description : Testing for inversioncounter.cpp
...
run_test_with_args_and_input "slow" "1 1 1 1" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
...
run_test_with_args_and_input "slow" "3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
...
run_test_with_args_and_input "slow" "20 18 19 17 16 15 14 13 11 12 21" "Enter sequence of integers, each followed by a space: Number of inversions: 43"
...
run_test_with_args_and_input "slow" "$(echo {500..401})" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
run_test_with_args_and_input "slow" "$(echo {500..400})" "Enter sequence of integers, each followed by a space: Number of inversions: 5050"
run_test_with_args_and_input "slow" "$(echo {500..0})" "Enter sequence of integers, each followed by a space: Number of inversions: 125250"
run_test_with_args_and_input "slow" "$(echo {4500..0})" "Enter sequence of integers, each followed by a space: Number of inversions: 10127250"
run_test_with_args_and_input "slow" "$(echo {100000..0})" "Enter sequence of integers, each followed by a space: Number of inversions: 5000050000"
# TESTS 1-20
# END slow tests
...
run_test_with_args_and_input "" "3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
...
run_test_with_args_and_input "" "20 18 19 17 16 15 14 13 11 12 21" "Enter sequence of integers, each followed by a space: Number of inversions: 43"
run_test_with_args_and_input "" "$(echo {100..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
run_test_with_args_and_input "" "$(echo {500..401})" "Enter sequence of integers, each followed by a space: Number of inversions: 4950"
run_test_with_args_and_input "" "$(echo {500..400})" "Enter sequence of integers, each followed by a space: Number of inversions: 5050"
run_test_with_args_and_input "" "$(echo {500..0})" "Enter sequence of integers, each followed by a space: Number of inversions: 125250"
run_test_with_args_and_input "" "$(echo {4500..0})" "Enter sequence of integers, each followed by a space: Number of inversions: 10127250"
run_test_with_args_and_input "" "$(echo {100000..0})" "Enter sequence of integers, each followed by a space: Number of inversions: 5000050000"
# TESTS 21-34
